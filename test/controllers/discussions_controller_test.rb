...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { description: @discussion.description, topic: @discussion.topic } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { description: @discussion.description, topic: @discussion.topic } }
